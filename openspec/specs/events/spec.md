...
Classify the outcome of locking a piece into a single `Event` — its kind, name,
difficulty, and the running back-to-back / combo state — turning raw placements
into the facts a scoring or analysis layer consumes.
