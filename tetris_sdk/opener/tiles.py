...
board minus the start stack (:mod:`tetris_sdk.opener.lifted`). One wrinkle
...
if the bitboard BFS (:mod:`tetris_sdk.opener.fastreach`) can reach it — kicks,
...
from tetris_sdk.opener.lifted import frames, to_real
from tetris_sdk.opener.tiling import tile
