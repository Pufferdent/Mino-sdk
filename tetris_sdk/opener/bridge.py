...
:func:`tetris_sdk.engine.reachable`, whose search covers rotation, kicks and
...
reach; :mod:`tetris_sdk.opener.hold` decides which queues can actually produce
one. Constraints live in :mod:`tetris_sdk.opener.constraints`.
"""
...
from tetris_sdk.board import Board, COLS
from tetris_sdk.engine import SpinType, reachable
from tetris_sdk.fumen.encoder import encode_fumen
from tetris_sdk.fumen.parser import parse_fumen
from tetris_sdk.opener import constraints as _c
from tetris_sdk.opener import fastreach as _fast
from tetris_sdk.opener import hold as _hold
from tetris_sdk.opener.node import Node
from tetris_sdk.pieces import Piece, PieceType, RotationSystem
...
class LineClear:
    ...
    @property
    def name(self) -> str:
        from tetris_sdk.events import classify_lock
...
class Route:
    ...
    def attack(self, *, b2b: bool = False,
        ...
        :func:`tetris_sdk.events.attack`.
        """
        from tetris_sdk.events import B2BRule, attack, is_difficult
    ...
    def b2b(self, *, initial: bool = False,
        ...
        from tetris_sdk.events import B2BRule, is_difficult
        rule = rule or B2BRule.S2
        count = 0
        alive = initial
        for step in self.steps:
...
class Bridge:
    ...
    SRS, or any other :class:`~tetris_sdk.pieces.RotationSystem`.
    """
    ...
    def routes(self, solver=None, cap: int | None = None) -> list:
        ...
        :class:`~tetris_sdk.opener.tiles.TileSolver` is used.
        """
        if solver is None:
