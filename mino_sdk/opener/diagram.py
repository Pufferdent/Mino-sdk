...
:class:`~mino_sdk.opener.bridge.Route`), and every queue is attributed to the
...
from mino_sdk.opener.bridge import _ORDER, Bridge
from mino_sdk.opener.fastreach import DEFAULT_SYSTEM
from mino_sdk.opener.node import Node
from mino_sdk.pieces import PieceType, RotationSystem
...
class Diagram:
    ...
    def optimize(self, start: Node, score=None, *, terminal=None,
        ...
        :class:`~mino_sdk.opener.bridge.Route` (``None`` scores everything
