...
:class:`~mino_sdk.opener.tiles.TileSolver` — lifted exact cover proposes,
...
anything implementing :class:`~mino_sdk.opener.solver.Solver` can be passed
...
from mino_sdk.opener.constraints import (
    Clears,
    Constraint,
    KeepB2B,
    NoGravityWait,
...
from mino_sdk.opener.diagram import Choice, Diagram, Line, Odds
from mino_sdk.opener.node import Node
from mino_sdk.opener.solver import Solver, Unsolved
