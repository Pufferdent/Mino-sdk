...
* the **non-queued** leftover — pieces beyond that window, which are leftover no
  matter what the solver does (see :func:`mino_sdk.pc.leftover.nonqueued`).
...
from mino_sdk.pc.leftover import nonqueued
from mino_sdk.pc.sfinder import PathResult
