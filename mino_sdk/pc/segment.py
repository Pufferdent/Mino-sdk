...
from mino_sdk.fumen.decoder import FUMEN_COLS, FUMEN_TO_CELL, decode_fumen
from mino_sdk.pc.fumen_ops import apply_operation_detailed
from mino_sdk.pc.fumen_ops import _OP_TYPE_TO_LETTER
from mino_sdk.pc.leftover import pc_number
...
def _deal_from_seed(seed, count: int) -> str:
    ...
    from mino_sdk.sim.queue import Queue
    from mino_sdk.sim.rng import JstrisRng
